...
let precios = [33000, 169000, 36000, 360000, 11000, 540000, 21000, 66000, 25000];
let stock = [5, 2, 8, 3, 10, 4, 3, 1, 2];
let precioTransporte = [600, 1200, 2000, "gratis"];
let IVA = 0.18;
let uniUser;
...
//deshabilita boton datos pers:
document.getElementById("botonDatos").disabled = true;
/**/ document.getElementById("botonDatos").disabled = true;
/**/ document.getElementById("botonDatos").disabled = true; 

//para validacion de unidades:
return;
}
else{
todoBien = true;
...
//sin errores, carga el carro de la compra:
if (todoBien){
calculaElTotal();
}
}
